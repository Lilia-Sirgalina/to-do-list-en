...
![App Screenshot](todoList-screenshot.JPG)

### How to Use:
1. Enter tasks one by one, pressing Enter after each entry or clicking the **"Add"** button.
2. The added tasks will appear in the list below.
3. To cross out a task, click on it once.
4. You can also remove the crossing out by clicking the task again.
5. To delete a task, double-click on it.
6. To delete the entire to-do list, click the **"Delete"** button.

### Features:
- Adding and removing to-do items using React state and JSX.
